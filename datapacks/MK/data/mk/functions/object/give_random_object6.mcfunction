...
execute as @s[scores={number=2},tag=!rand_fun] run function mk:object/random_cube/random_nb_4
...
execute as @s[tag=!rand_fun] unless entity @s[scores={number=..2}] run function mk:object/random_cube/random_nb_7
