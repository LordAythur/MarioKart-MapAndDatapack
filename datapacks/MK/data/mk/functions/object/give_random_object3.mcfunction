...
execute as @s[scores={number=5},tag=!rand_fun] run function mk:object/random_cube/random_nb_7



#Si 8 ème ou pas de score
execute as @s[tag=!rand_fun] unless entity @s[scores={number=..5}] run function mk:object/random_cube/random_nb_8
